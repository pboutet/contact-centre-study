...
from datasets.bert_processors.abstract_processor import convert_examples_to_features_long
...
class BertTrainer(object):
    def __init__(self, model, optimizer, processor, scheduler, tokenizer, args):
        ...
        self.train_examples = self.processor.get_train_examples(args.data_dir, args.training_file)

        timestamp = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
        self.snapshot_path = os.path.join(self.args.save_path, self.processor.NAME, '{}_{}_{}_{}.pt'.format(self.args.model,self.args.training_file,self.args.max_seq_length, timestamp))
    ...
    def train(self):
        ...
        for epoch in trange(int(self.args.epochs), desc="Epoch"):
            ...
            dev_acc, dev_precision, dev_recall, dev_f1, dev_loss, report = dev_evaluator.get_scores()[0]
