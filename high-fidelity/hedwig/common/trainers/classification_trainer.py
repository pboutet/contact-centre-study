...
class ClassificationTrainer(Trainer):
    ...
    def train(self, epochs):
        ...
        for epoch in range(1, epochs + 1):
            ...
            # 221111-Pat: since we added the dev report as a return object in classification_evaluator.py-->get_scores(), wherever we call get_scores() we need to put something to catch the new dev report object even if it's unused. otherwise there is a return argument mismatch.
            dev_acc, dev_precision, dev_recall, dev_f1, dev_loss, dev_report = self.dev_evaluator.get_scores()[0]#add variable to handle classification report return
