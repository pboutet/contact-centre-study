...
class BertEvaluator(object):
    ...
    def get_scores(self, silent=False):
        ...
        report = metrics.classification_report(target_labels, predicted_labels)
        ...
        return [accuracy, precision, recall, f1, avg_loss, report], ['accuracy', 'precision', 'recall', 'f1', 'avg_loss', 'classification_report']
